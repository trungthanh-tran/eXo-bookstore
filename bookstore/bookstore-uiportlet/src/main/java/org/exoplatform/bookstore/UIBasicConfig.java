...
public class UIBasicConfig extends UIForm {
    ...
    public static final String TEXT_STRING_INPUT = "UIBookstorePortletTextStringInput";
 
    public UIBasicConfig() {
        PortletRequestContext portletRequestContext = WebuiRequestContext.getCurrentInstance();
        PortletPreferences preferences = portletRequestContext.getRequest().getPreferences();
        String text = preferences.getValue(UIBookstorePortlet.TEXT_PREFERENCE, null);
    ...
    public static class SaveActionListener extends EventListener<UIBasicConfig> {
        public void execute(Event<UIBasicConfig> event) throws Exception {
            ...
            PortletRequestContext portletRequestContext = WebuiRequestContext.getCurrentInstance();
            PortletPreferences preferences = portletRequestContext.getRequest().getPreferences();
            preferences.setValue(UIBookstorePortlet.TEXT_PREFERENCE, textStringInput.getValue());
            preferences.store();
